...
project = u'messaging'
copyright = u'Copyright (C) CERN 2013-2021 - Author: %s' % (messaging.AUTHOR, )
...
texinfo_documents = [
  ('index', 'messaging', u'messaging Documentation',
   u'Massimo Paladin', 'messaging', 'One line description of project.',
   'Miscellaneous'),
]
